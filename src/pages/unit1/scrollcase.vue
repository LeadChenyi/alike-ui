<template>
    <div>
        <alike-divider>scroll dehavior</alike-divider>
        <nav>
            <a href="#page-1">1</a>
            <a href="#page-2">2</a>
            <a href="#page-3">3</a>
        ...
        <alike-divider>scrolling 、scroll up 、scroll down</alike-divider>
        ...
        <div
            ...
            "
        >
            <p>是否处于滚动中:{{ isScroll ? "是" : "否" }}</p>
            <p>是否处于向上滚动:{{ isScrollUp ? "是" : "否" }}</p>
        </div>
    </div>
</template>
